...
class I18n:
    ...
    def _get_locales_dir(self) -> Path:
        ...
        # Locales are in the same directory as this module
        return Path(__file__).parent / 'language'
    ...
    def get(self, key: str, default: str = None, **kwargs) -> str:
        ...
        Args:
            ...
            default: Default text to return if translation not found
            **kwargs: Parameters for string formatting
        
        Returns:
            Translated text or default/key if translation not found
        """
        with self._lock:
            ...
            # Return default if provided, otherwise key
