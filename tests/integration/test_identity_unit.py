...
def load_identity_module():
    # When running in Docker container, module is at /app/identity/src/identity.py
    # When running locally, it's at ../../identity/src/identity.py
    import sys
    base_docker = "/app/identity"
    base_local = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "identity"))
