...
echo "   Required subdomains: admin, sso, identity, storage, smtp, imap,"
echo "                        client, mail, apidocs, test-suite, services"
...
echo "   👨‍💼 Admin Panel:  https://admin.digidig.cz"
...
echo "   � Client:        https://client.digidig.cz:445"
echo "   📚 API Docs:      https://apidocs.digidig.cz:445"
echo "   🧪 Test Suite:    https://test-suite.digidig.cz:445"
